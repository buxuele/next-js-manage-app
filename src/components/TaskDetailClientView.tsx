...
interface TaskDetailClientViewProps {
  task: Task;
  lineNumbers: string;
  highlightedCodeHTML: string;
}

export function TaskDetailClientView({
  task,
  lineNumbers,
  highlightedCodeHTML,
}: TaskDetailClientViewProps) {
      ...
      >
        <div className="container" style={{ maxWidth: "1200px" }}>
          ...
          <div className="d-flex align-items-center">
            <span className="navbar-text me-3" title={task.description}>
